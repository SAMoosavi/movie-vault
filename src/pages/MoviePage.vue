            ...
            <template v-else>
              ...
              <div v-if="loading" class="mt-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  >
                    <div
                      class="card card-compact bg-base-100 cursor-pointer shadow-lg transition-shadow hover:shadow-xl"
                    >
              ...
              <div v-else-if="searchItems.length === 0 && movieName" class="py-8 text-center">
                <i data-lucide="search-x" class="text-base-content/30 mx-auto mb-4 h-16 w-16"></i>
                <p class="text-base-content/70">No movies found for "{{ movieName }}"</p>
              </div>

              <!-- Empty State -->
              <div v-else class="py-12 text-center">
                <i data-lucide="search" class="text-base-content/30 mx-auto mb-4 h-16 w-16"></i>
