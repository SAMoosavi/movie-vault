...
<template>
  <main class="container mx-auto">
    <button class="btn btn-block" @click="add_dir">add file</button>
    <div v-if="loading">
        ...
        <div class="card-body">
          <h2 class="card-title">
            ...
            <span class="badge badge-secondary"
              v-if="movie.imdb_metadata?.imdb_rating && movie.imdb_metadata?.imdb_rating != 'N/A'">
          ...
          <div class="card-actions justify-end">
            <span v-if="movie.series">
              s{{ movie.series.season }} e{{ movie.series.episode }}
            </span>
